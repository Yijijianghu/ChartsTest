...
//    combineChart.descriptionText = @"";
    combineChart.chartDescription.text=@"";
    ...
    xAxis.drawGridLinesEnabled = NO;
//    xAxis.valueFormatter = [[ChartIndexAxisValueFormatter alloc] initWithValues:xValues];
    XAxisValueFormatter *xAxisValueFormatter = [[XAxisValueFormatter alloc] init];
    //
    xAxisValueFormatter.xAxisDatas=xValues;
...
//    xAxis.valueFormatter = [[DayAxisValueFormatter alloc] initForChart:combineChart];
